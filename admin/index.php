<?php 
  ...
  if (isset($_SESSION[id])){          
      ...
      $pegawai = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT count(*) as total FROM pegawai"));
      $pelanggan = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT count(*) as total FROM pelanggan"));
      $pengumuman = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT count(*) as total FROM pengumuman"));
      $pengaduan_masuk = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT count(*) as total FROM pengaduan where status_pengaduan='dikirim'"));
      $pengaduan_proses = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT count(*) as total FROM pengaduan where status_pengaduan='diproses' || status_pengaduan='terjadwal' ||status_pengaduan='disurvei'"));
      $pengaduan_selesai = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT count(*) as total FROM pengaduan where  status_pengaduan='selesai'"));
      $hasil = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT count(*) as total from hasil_cek inner join cek_berkala on hasil_cek.id_cek = cek_berkala.id_cek inner join pelanggan on hasil_cek.id_pelanggan = pelanggan.id_pelanggan"));
?>
<!DOCTYPE html>
<html>
  <head>
    ...
    <title>Admin || PDAM Tirta Agung</title>
      ...
      <div class="content-wrapper">
        ...
        <?php 
          ...
          elseif ($_GET[view]=='admin'){
            ...
            echo "</div>";
          }elseif ($_GET[view]=='pelanggan'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/pelanggan.php";
            echo "</div>";
          }elseif ($_GET[view]=='pengumuman'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/pengumuman.php";
            echo "</div>";
          }elseif ($_GET[view]=='pengaduan_masuk'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/pengaduan_masuk.php";
            echo "</div>";
          }elseif ($_GET[view]=='pengaduan_proses'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/pengaduan_proses.php";
            echo "</div>";
           }elseif ($_GET[view]=='pengaduan_selesai'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/pengaduan_selesai.php";
            echo "</div>";
             }elseif ($_GET[view]=='penilaian'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/penilaian.php";
            echo "</div>";
            ...
            echo "</div>";
          }elseif ($_GET[view]=='sms_pengumuman'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/sms_pengumuman.php";
            echo "</div>";  
          }elseif ($_GET[view]=='sms_cekberkala'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/sms_cekberkala.php";
            echo "</div>";      
          }elseif ($_GET[view]=='sms_pengaduan'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/sms_pengaduan.php";
            echo "</div>";  
