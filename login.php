...
<html>
  <head>
    ...
    <title>PDAM Tirta Agung || Login</title>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
         <img src="images/pdam.PNG" width="100%">
      ...
      <div class="login-box-body">
        ...
        <form action="proses_login.php" method="post" >
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
              <button name='batal' type="reset" class="btn btn-secondary btn-block btn-flat">batal</button>
            </div><!-- /.col -->
            <hr>
           </div>
          </form><hr> <a href="index.php">kembali</a>
       </div><!-- /.login-box-body -->
     </div><!-- /.login-box -->
