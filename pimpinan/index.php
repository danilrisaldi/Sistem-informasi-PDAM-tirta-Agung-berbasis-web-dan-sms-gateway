...
<html>
  <head>
    ...
    <title>Pimpinan || PDAM Tirta Agung</title>
      ...
      <div class="content-wrapper">
        ...
        <section class="content" >
          ...
          if ($_GET[view]=='dashboard' OR $_GET[view]==''){
            ...
            cek_session_pimpinan();
            echo "<div class='row'>";
                    include "konten/grafik_pegawai.php";
            echo "</div>";
          }elseif ($_GET[view]=='pelanggan'){
            cek_session_pimpinan();
            echo "<div class='row'>";
                    include "konten/grafik_pelanggan.php";
            echo "</div>";
          }elseif ($_GET[view]=='cek_berkala'){
            cek_session_pimpinan();
            echo "<div class='row'>";
                    include "konten/grafik_cekberkala.php";
            echo "</div>";
          }elseif ($_GET[view]=='pengaduan'){
            cek_session_pimpinan();
            echo "<div class='row'>";
                    include "konten/grafik_pengaduan.php";
            echo "</div>";
          }elseif ($_GET[view]=='penilaian'){
            cek_session_pimpinan();
            echo "<div class='row'>";
                    include "konten/grafik_penilaian.php";
            echo "</div>";
          }
